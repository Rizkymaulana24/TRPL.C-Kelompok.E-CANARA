...
@section('main')
  <div class="container">
    ...
    <nav class="navbar navbar-light rounded text-light shadow-sm">
...
<table class="table table-bordered table-hover table-striped">
  <thead>
    <tr>
      <th>Scan Bukti Transfer</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td> 
        <img src="{{ asset('uploads/scan_buktitransfer/'.$user->scan_buktitransfer) }}" style="height:120px; width:200px"/>
      </td>
    </tr>
  </tbody>
</table>
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between">
            <div>
              <a class="btn btn-secondary" href="{{ route('penyelenggaraprem') }}" >Kembali</a>
            </div>
            <div>
              <a class="btn btn-outline-primary" href="{{ route('penyelenggaraprem.password') }}" >Ubah Password</a>
              <a class="btn btn-primary" href="{{ route('penyelenggaraprem.edit') }}" role="button">Edit</a>
            </div>
          </div>
        </div>
