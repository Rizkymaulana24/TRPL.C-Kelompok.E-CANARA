...
@section('main')
  <div class="container">
    ...
    <nav class="navbar navbar-light bg-light text-dark rounded shadow-sm">
      <span class="h3 m-0">Data Narasumber Premium</span>
    </nav>
              ...
              @foreach ($narasumbers as $narasumber)
                <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-outline-info btn-sm" href="{{ route('admin.narasumberpremium.show',['id' => $narasumber->id]) }}" role="button">Detail</a>
                    </div>
                  </td>
                </tr>
              @endforeach
