...
@section('main')
  <div class="container">
    ...
    <div class="spacer-2"></div>
    <form class='form-inline d-flex justify-content-center md-form form-sm mt-0' action="{{ route('narasumber.cari') }}" method="GET">
                ...
                <tbody>
                  @foreach ($kegiatans as $kegiatan)
                    <tr>
                      ...
                      <td>
                  <a class="btn btn-sm btn-link" data-toggle="modal" data-target="#detailmodal" role="button">Detail</a>
                  </tr>
                  @endforeach
                </tbody>
              </table>
