  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <!-- <div class="col-lg-3">
        <div class="card shadow-sm">
          <div class="card-body">
            <a class="btn btn-sm btn-primary" href="{{ route('penyelenggara.kegiatan.edit',['id' => $kegiatan->id]) }}" role="button">Ubah</a>
          </div> -->
          <div class="card-footer bg-light">
            <a class="btn btn-sm btn-secondary float-right" href="{{ route('penyelenggara.kegiatan') }}" >Kembali</a>
          </div>
        </div>
      </div>
